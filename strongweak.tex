...
\begin{abstract}
  ...
  Proposition~\ref{prop_stabilizer1} looks interesting. Can it be strengthened to obtain a type-definable group?
...
\begin{proposition}
  ...
  \ceq{\hfill{\gr h_i}}{\in}{\Big\<\bigcup_{{\gr g}\in\grZ}({\gr g})_H^{-1}\!\cdot({\gr g})_H\Big\>.}
\end{proposition}
